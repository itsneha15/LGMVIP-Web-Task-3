...
function productAdd()
{
    ...
    if (count % 2 == 0) {
        $("#productTable tbody").append("<tr>" + "<td id='newData' class='animated fadeIn' style='height:100%;font-size:medium;margin-left:240px;padding:2px'>" + "<b>" + $("#name").val() + "</b>" + "<br>" +
    ...
    // Even Row elements 
        ...
        $("#productTable tbody").append("<tr>" + "<td id='newData' class='animated fadeIn'style='margin-left:240px;height:100%;font-size:medium;padding:2px' >" + "<b>" + $("#name").val() + "</b>" + "<br>" +
